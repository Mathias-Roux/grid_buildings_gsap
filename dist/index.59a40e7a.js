...
_gsap.gsap.set(DOM.contents.evolution.paragraphs, {
    opacity: 0
});
...
_gsap.gsap.set(DOM.contents.duplex.paragraphs, {
    opacity: 0
});
...
_gsap.gsap.set(DOM.contents.orange.paragraphs, {
    opacity: 0
});
const swapContent = (index)=>{
    const tl = _gsap.gsap.timeline({
        ...
        opacity: 1,
        ease: 'Power2.Out'
    }, 'switch').to(DOM.contents[Object.keys(DOM.contents)[index]].paragraphs, 0.5, {
        opacity: 1,
        ease: 'Power2.Out'
    }, 'switch');
    return tl;
...
},{"gsap":"fPSuC","splitting/dist/splitting.css":"3uR7n","splitting/dist/splitting-cells.css":"7jeGL","splitting":"77jB6","./Canvas.js":"6XxlH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
    ...
    initCanvas() {
        ...
        paper.view.onFrame = (event)=>{
            if (!this.isStuck) {
                ...
                this.lastX = _utilDefault.default.lerp(this.lastX, this.clientX, this.outerCursorSpeed);
                this.lastY = _utilDefault.default.lerp(this.lastY, this.clientY, this.outerCursorSpeed);
                this.group.position = new paper.Point(this.lastX, this.lastY);
            } else if (this.isStuck) {
                // fixed position on a nav item
                this.lastX = _utilDefault.default.lerp(this.lastX, this.stuckX, this.outerCursorSpeed);
                this.lastY = _utilDefault.default.lerp(this.lastY, this.stuckY, this.outerCursorSpeed);
                this.group.position = new paper.Point(this.lastX, this.lastY);
            }
            if (this.isStuck && polygon.bounds.width < shapeBounds.width) // scale up the shape
            polygon.scale(1.08);
            ...
            if (this.isStuck && polygon.bounds.width >= shapeBounds.width) {
                ...
                polygon.segments.forEach((segment, i)=>{
                    ...
                    const distortionX = _utilDefault.default.map(noiseX, -1, 1, -noiseRange, noiseRange);
                    const distortionY = _utilDefault.default.map(noiseY, -1, 1, -noiseRange, noiseRange);
...
},{"./Util":"1d9Oh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1d9Oh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Util {
    static lerp(a, b, n) {
